...
export const departments = [
  { name: "Islamiat", hod: "Professor Mrs. Ghazala Arif Dougal", description: "Quranic studies, Hadith, Fiqh and Islamic history, with a focus on ethical formation." },
  { name: "Chemistry", hod: "Ms. Arousa", description: "Organic, inorganic and physical chemistry supported by two teaching laboratories." },
  { name: "Urdu", hod: "Mrs. Farhana Syed", description: "Classical and modern Urdu literature, linguistics, prosody and creative writing." },
  { name: "Home Economics", hod: "Ms. Zarmina", description: "Food and nutrition, textiles, and household resource management." },
  { name: "Pakistan Studies", hod: "Ms. Asma Parveen", description: "Freedom movement, constitutional development and contemporary national affairs." },
  { name: "Economics", hod: "Ms. Batool", description: "Micro and macroeconomics, public finance and the economy of Pakistan." },
  { name: "Education", hod: "Mrs. Shaheen Maria", description: "Social structures, rural communities and gender studies in the Pakistani context." },
  { name: "Mathematics", hod: "Ms. Ayesha", description: "Calculus, algebra, geometry and mathematical methods for the sciences." },
  { name: "Statistics", hod: "Ms. Fida Shafiq", description: "Probability, statistical inference and data analysis with computing support." },
  { name: "Zoology, Botany & Biotechnology", hod: "Ms. Nayab", description: "Life sciences teaching with specimen collections and a shared biology laboratory." },
  { name: "Physics", hod: "Ms. Sadaf Naseem Cheema", description: "Mechanics, electromagnetism and modern physics with practical demonstrations." },
  { name: "Psychology", hod: "Ms. Qamar Tariq", description: "General, developmental and educational psychology with counselling exposure." },
  { name: "Computer Science", hod: "Ms. Samavia Hafeez", description: "Programming, databases, networks and software development in a dedicated lab." },
];

export const councilMembers = [
  { name: "Prof. Farhana Faheem", designation: "Principal — Chairperson" },
  { name: "Prof. Farhana Saeed", designation: "Vice Principal" },
  { name: "Mrs. Humaira Almas", designation: "Chief Proctor" },
  { name: "Mrs. Farhana Faheem", designation: "Convener, Admission Committee" },
  { name: "Mrs. Farhana Syed", designation: "Convener, Examination Committee" },
  { name: "Mrs. Humaira Almas", designation: "In-charge, Discipline Committee" },
  { name: "Ms. Reema Asif", designation: "Librarian" },
  { name: "Mr. Gulzar Ahmad Mehr", designation: "Head Clerk / Office Superintendent" },
  { name: "Committees", designation: "Coordinator, Scholarships & Financial Aid" },
  { name: "Faculty", designation: "Coordinator, Co-curricular Activities" },
];

export const faculty = [
  { name: "Mrs. Farhana Faheem", designation: "Associate Professor of English" },
  { name: "Ms. Arousa", designation: "Assistant Professor of Chemistry" },
  { name: "Mrs. Farhana Syed", designation: "Assistant Professor of Urdu" },
  { name: "Mrs. Humaira Almas", designation: "Lecturer in Urdu" },
  { name: "Mrs. Sadia Abdul Salam", designation: "Lecturer in Islamic Studies" },
  { name: "Ms. Qamar Tariq", designation: "Lecturer in Psychology" },
];
